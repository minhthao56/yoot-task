...
import {DevicePage ,ProjectPage,StatusTaskPage,CreateStatusPage,CreateProjectPage,  CreateTaskPage, HomePage, LoginPage, TasksPage, UpdateTaskPage, CreatePriorityPage, PriorityPage, VersionPage, CreateVersionPage,NewProjectPage,UpdateProjectPage, NewStatusPage, UpdateStatusPage } from "../pages";
